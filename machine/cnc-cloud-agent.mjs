...
async function execute(command) {
  const routes = { probe_bed: "/probe/bed", probe_stock: "/probe/stock", lock_probe: "/probe/lock", unlock_probe: "/probe/unlock", recover_probe: "/probe/recover", zero_xy: "/zero/xy", start: "/job/start", pause: "/job/pause", resume: "/job/resume", stop: "/job/stop" };
